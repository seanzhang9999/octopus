...
from anp_server_framework.anp_service.anp_sdk_group_runner import Message, MessageType
...
class GroupMemberSDK:
    ...
    async def join_group(self, group_id: str, did: str = None,
        ...
        if self.use_local_optimization and self._local_sdk:
            ...
            if runner:
                from anp_server_framework.anp_service.anp_sdk_group_runner import Agent
                agent = Agent(
                    id=self.agent_id,
